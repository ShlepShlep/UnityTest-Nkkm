...
public class Board : MonoBehaviour
{
    ...
    {
        TextAsset textFile = Resources.Load("AllWords") as TextAsset;
        validWords = textFile.text.Split('\n');

        textFile = Resources.Load("CommonWords") as TextAsset;
    ...
    private void Update()
    {
        ...
        {
            if (Input.GetKeyDown(KeyCode.Return))//keycode.return tai cia enter
            {
    ...
    #region daug paprastesnis variantas
        // for (int i = 0; i < row.tiles.Length; i++)
        // {
        //     Tile tile = row.tiles[i];
